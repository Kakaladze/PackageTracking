module.exports.InpostPackageTypes = {
...
module.exports.InpostPackageCheck = {
    inpost_locker_standard: 'locker',
    inpost_locker_allegro: 'locker',
    inpost_locker_pass_thru: 'locker',
    inpost_letter_allegro: 'courier',
    inpost_courier_allegro: 'courier',
    inpost_courier_c2c: 'courier',
};

module.exports.InpostPackageStatuses = (callback) => {
    callback('pass');
};
